...
func TestDecodeV2Request_path(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath: "/pets/luna",
	}

	r, err := decodeV2Request(context.Background(), e)
...
func TestDecodeV2Request_method(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath: "/pets/luna",
...
func TestDecodeV2Request_queryString(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath:        "/pets",
...
func TestDecodeV2Request_multiValueQueryString(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath:        "/pets",
...
func TestDecodeV2Request_remoteAddr(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath: "/pets",
		RequestContext: events.APIGatewayV2HTTPRequestContext{
			HTTP: events.APIGatewayV2HTTPRequestContextHTTPDescription{
...
func TestDecodeV2Request_header(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath: "/pets",
		Body:    `{ "name": "Tobi" }`,
...
func TestDecodeV2Request_multiHeader(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath: "/pets",
		Body:    `{ "name": "Tobi" }`,
		Headers: map[string]string{
...
func TestDecodeV2Request_body(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath: "/pets",
		Body:    `{ "name": "Tobi" }`,
		RequestContext: events.APIGatewayV2HTTPRequestContext{
...
func TestDecodeV2Request_bodyBinary(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{
		RawPath:         "/pets",
...
func TestDecodeV2Request_context(t *testing.T) {
	e := events.APIGatewayV2HTTPRequest{}
	ctx := context.WithValue(context.Background(), "key", "value")
	r, err := decodeV2Request(ctx, e)
	assert.NoError(t, err)
